...
```{r Steps per Day Mean/Med, results = "asis"}
library(xtable)
...
```{r Average Interval Activity - Max, results = "asis"}
...
### Calculate and report the mean and median total number of steps taken per day.
```{r Total Steps by Day - Mean/Med, results = "asis"}
